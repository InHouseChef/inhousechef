...
export const TermsAndConditionsIcon = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' {...props}>
            ...
            />
            <path
                d='M14.4756 2.75V5.659C14.4756 7.079 15.6236 8.23 17.0436 8.234H19.7986'
                stroke='currentColor'
                strokeWidth='1.5'
                strokeLinecap='round'
                strokeLinejoin='round'
