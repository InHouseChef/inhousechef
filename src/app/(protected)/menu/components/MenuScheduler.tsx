        ...
        <Form {...form}>
            <form onSubmit={handleSubmit(onSubmit)} className='h-full space-y-8'>
                ...
                <div className='flex flex-col space-y-4 lg:flex-row lg:space-x-4 lg:space-y-0'>
                    ...
                    <div className='flex-start relative flex min-w-[300px] flex-grow flex-col rounded-lg bg-white p-4 shadow-lg'>
                            ...
                            {isAssignmentMode && (
                                <div className='grid gap-4'>
                                    {meals.map(meal => (
                                        <div
                                            key={meal.id}
                                            className={`flex cursor-pointer items-center rounded-lg bg-gray-100 p-4 shadow-md ${value.includes(meal.id) ? 'bg-blue-100' : ''}`}
                                            onClick={() =>
                                                handleMealSelection(
                                            ...
                                            <div className='mr-4 h-16 w-16 rounded-lg bg-gray-200'>
                                                {meal.imageUrl ? (
                                                    <img
                                                        src={meal.imageUrl}
                                                        alt={meal.name}
