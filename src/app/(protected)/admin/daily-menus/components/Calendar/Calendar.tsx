    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                nav_button_previous: 'w-9 h-9 absolute left-1',
                nav_button_next: 'w-9 h-9 absolute right-1',
                table: 'w-full border-collapse space-y-1',
                head_row: 'flex',
                head_cell: 'text-muted-foreground rounded-md w-24 font-normal text-[1.25rem]',
                ...
                day: cn(buttonVariants({ variant: 'ghost' }), 'h-24 w-24 p-0 font-normal aria-selected:opacity-100'),
