                ...
                <div
                    ...
                    <div>
                        <input
                            ...
                            {...rest}
                        />
                        <div className='pointer-events-none flex h-5 w-5 select-none items-center justify-center rounded-[3px] border border-[#ced3e0] text-white  peer-checked:border-primary peer-checked:bg-primary peer-checked:text-white peer-checked:disabled:border-primary500 peer-checked:disabled:bg-primary500 peer-hover:border-[#c9d6ff] peer-hover:text-[#c9d6ff]'>
